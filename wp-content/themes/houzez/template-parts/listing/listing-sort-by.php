...
<div class="sort-by">
	<div class="d-flex align-items-center">
		...
		<select id="<?php echo esc_attr($sort_id); ?>" class="selectpicker form-control bs-select-hidden" title="<?php esc_html_e( 'Default Order', 'houzez' ); ?>" data-live-search="false" data-dropdown-align-right="auto">
			...
			<option <?php selected($sortby, 'random'); ?> value="random"><?php esc_html_e('Random Order', 'houzez'); ?></option>
            ...
            <option <?php selected($sortby, 'd_date'); ?> value="d_date" selected="Selected"><?php esc_html_e('Date - New to Old', 'houzez' ); ?></option>
