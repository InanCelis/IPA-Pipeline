...
$dashboard_property_owner = houzez_get_template_link_2('template/user_dashboard_property_owner.php');
...
$dashboard_partnership = houzez_get_template_link_2('template/user_dashboard_partnership.php');
...
if( is_page_template( 'template/user_dashboard_profile.php' ) ) {
    ...
    $ac_fav = 'class=active';
} elseif ( is_page_template( 'template/user_dashboard_property_owner.php' ) ) {
    $ac_own = 'class=active';
...
// Add this code after the property counts section:
...
<ul class="side-menu list-unstyled">
	...
	if ( !is_user_logged_in() ) {
		...
		if( !empty( $dashboard_partnership ) && current_user_can('administrator') ) { ?>
		<?php
			$partnership_menu = '';
			$partnership_menu .= '<li class="side-menu-item '.esc_attr($parent_partnership).'">';
			$partnership_menu .= '<a '.$ac_partnership.' href="'.esc_url($dashboard_partnership).'">
				<i class="houzez-icon icon-task-list-text-1 mr-2"></i> Partnership
			</a>';
			$partnership_menu .= '<ul class="side-menu-dropdown list-unstyled">';
			...
			$partnership_menu .= '<li class="side-menu-item">
				<a href="'.esc_url($partnership_reports).'">
					<i class="houzez-icon icon-arrow-right-1"></i> Tally Reports
				</a>
			</li>';
			$partnership_menu .= '<li class="side-menu-item">
				<a href="'.esc_url($partnership_fields).'">
