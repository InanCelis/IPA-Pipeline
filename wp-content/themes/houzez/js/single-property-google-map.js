...
jQuery(function ($) {
  ...
  if (typeof houzez_single_property_map !== "undefined") {
    ...
    var propertyLatLng = new google.maps.LatLng(
      houzez_single_property_map.lat,
      houzez_single_property_map.lng
    );
    var mapOptions = {
    ...
    houzezMap = new google.maps.Map(
      document.getElementById("houzez-single-listing-map"),
      mapOptions
    );
    ...
    $('a[href="#pills-street-view"]').on("shown.bs.tab", function () {
      ...
      if (streetCount <= 1) {
        panorama = new google.maps.StreetViewPanorama(
          document.getElementById("pills-street-view"),
          panoramaOptions
        );
      }
    });
    ...
    if (!showCircle) {
      if (markerPricePins == "yes") {
        var pricePin =
          ...
          houzez_single_property_map.term_id +
      ...
      if (houzez_single_property_map.thumbnail) {
        innerHTML +=
          ...
          infoWindowPlac +
          '" data-src="' +
          houzez_single_property_map.thumbnail +
          '" alt="' +
          houzez_single_property_map.title +
          '"/>' +
          "</a>";
      } else {
        innerHTML +=
      ...
      if (houzez_single_property_map.price) {
        innerHTML +=
          '<li class="item-price">' +
          houzez_single_property_map.price +
          "</li>";
      }
      ...
      if (houzez_single_property_map.property_type) {
        innerHTML +=
          '<li class="item-type">' +
          houzez_single_property_map.property_type +
          "</li>";
      }
