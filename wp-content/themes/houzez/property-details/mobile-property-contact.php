...
$agent_name = 'International Property Alerts';
...
$agent_number_call = '+442036270106';
	...
	<div class="d-flex justify-content-between">
		<div class="agent-details flex-grow-1">
			<div class="d-flex align-items-center">
				...
				<div class="agent-image">
					<img class="rounded" src="https://internationalpropertyalerts.com/wp-content/uploads/2025/03/site-logo-black-1-150x150.png" width="50" height="50" alt="<?php echo esc_attr($agent_name); ?>">
				</div>
				<ul class="agent-information list-unstyled">
					<li class="agent-name">
						<?php echo esc_attr($agent_name); ?>
